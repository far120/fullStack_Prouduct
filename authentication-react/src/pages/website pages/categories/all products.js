...
export default function AllProducts() {
  ...
  <img src={`${BackEnd_url}/images/products/${maincategory.image}`||`${BackEnd_url}/images/products/image-1728556100619-300378618.webp`}  className="card-img-top imges" style={{  height:"200px" ,  width:"74%" , objectFit:"fill", alignSelf:"center"}} alt={maincategory.name}/>
